...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.example.mysound.mediaservice.create"
        const val ACTION_DESTROY = "com.example.mysound.mediaservice.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
    ...
    private fun init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mMediaPlayer?.setAudioAttributes(AudioManager.STREAM_MUSIC)
        }
...
private fun MediaPlayer.setAudioAttributes(streamMusic: Int) {
